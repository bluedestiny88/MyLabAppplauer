...
class BlogRecyclerViewAdapter extends RecyclerView.Adapter<BlogRecyclerViewAdapter.BlogViewHolder> {

    //Store all of the blogs to present
    private final List<edu.uw.tcss450.ui.blog.BlogPost> mBlogs;
    //Store the expanded state for each List item, true -> expanded, false -> not
    private final Map<edu.uw.tcss450.ui.blog.BlogPost, Boolean> mExpandedFlags;

    public BlogRecyclerViewAdapter(List<edu.uw.tcss450.ui.blog.BlogPost> items) {
        mBlogs= items;
    ...
    public class BlogViewHolder extends RecyclerView.ViewHolder {
        ...
        private edu.uw.tcss450.ui.blog.BlogPost mBlog;
        ...
        /*** When the button is clicked in the more state, expand the card to display * the blog preview and switch the icon to the less state.  When the button * is clicked in the less state, shrink the card and switch the icon to the* more state.  * @param button the button that was clicked*/
        ...
        void setBlog(final edu.uw.tcss450.ui.blog.BlogPost blog) {
            mBlog = blog;
            ...
            final String preview =  Html.fromHtml(blog.getTeaser(), Html.FROM_HTML_MODE_COMPACT).toString().substring(0,100) //just a preview of the teaser
                    + "...";
